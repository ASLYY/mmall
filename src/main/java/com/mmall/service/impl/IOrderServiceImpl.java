...
//    private static final Logger logger = LoggerFactory.getLogger(IOrderServiceImpl.class);
    ...
    private ShippingVo assembleShippingVo(Shipping shipping) {
        ...
        shippingVo.setReceiverAddress(shippingVo.getReceiverAddress());
    ...
    private long generateOrderNo() {
        ...
        //return currentTime+currentTime%10;这样做的话会导致并发操作的时间戳相同，订单号重复,下单失败
    ...
    public ServerResponse<OrderVo> getOrderDetail(Integer userId, Long orderNo) {
        ...
        return ServerResponse.createByErrorMessage("咩有找到该订单");
    }
    ...
    public ServerResponse aliCallback(Map<String,String> params){
        ...
        System.out.println("订单状态tradeStatus ===============" + tradeStatus);
